(ns com.myapp
  (:require [com.biffweb :as biff]
            [com.myapp.email :as email]
            [com.myapp.app :as app]
            [com.myapp.home :as home]
            [com.myapp.middleware :as mid]
            [com.myapp.ui :as ui]
...
(defn on-save [ctx]
  ...
  (biff/eval-files! ctx)
  (generate-assets! ctx)
  (test/run-all-tests #"com.myapp.*-test"))
